...
<body style="font-family: sans-serif; max-width: 540px; margin: 0 auto; padding: 32px 16px; color: #111;">
  ...
  <p style="font-size: 13px; color: #666; margin-top: 0;">Someone wants to be featured on the Tanship showcase.</p>
  ...
  <p style="font-size: 11px; color: #aaa; margin-top: 32px;">Tanship Platform — admin notification</p>
</body>
</html>`;
